...
public class PatternConstants {
    ...
    public enum Pattern implements IEnum<String, String> {
        ...
        private static Map<String, String> columns = options.stream().collect(Collectors.toMap(IEnum::getCode, IEnum::getContent, (v1, v2) -> {

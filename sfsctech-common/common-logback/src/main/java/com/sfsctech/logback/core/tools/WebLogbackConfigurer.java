...
public class WebLogbackConfigurer {
    ...
    public static void initLogging(ServletContext servletContext) {
        ...
        String location = servletContext.getInitParameter(CommonConstants.LOGBACK_CONFIG_FILE_LOCATION_PARAM);
    ...
    private static boolean exposeWebAppRoot(ServletContext servletContext) {
        String exposeWebAppRootParam = servletContext.getInitParameter(CommonConstants.LOGBACK_EXPOSE_WEB_APP_ROOT_PARAM);

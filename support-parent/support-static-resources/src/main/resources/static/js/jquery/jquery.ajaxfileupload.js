jQuery.extend({
    ...
    addOtherRequestsToForm: function (form, data) {
        ...
        if (data instanceof Array) {
            jQuery.buildArray('', data, form, originalElement);
        } else {
            jQuery.buildObject('', data, form, originalElement);
        }
        return form;
    },

    buildObject: function (parent, data, form, input) {
        var name, value;
        // 解析对象
        for (var key in data) {
            name = key;
            ...
            if (value instanceof Array) {
                jQuery.buildArray(name, value, form, input);
            } else if (typeof value === 'object' && value) {
                jQuery.buildObject(name, value, form, input);
            } else {
                var cloneElement = input.clone();
    ...
    buildArray: function (parent, data, form, input) {
        var name, value;

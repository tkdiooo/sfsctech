...
public class LoginSuccessHandler extends BaseSuccessHandler implements AuthenticationSuccessHandler {
    ...
    public LoginSuccessHandler(CacheFactory<RedisProxy<String, Object>> factory, JwtFactory jwtFactory, TokenLoader tokenLoader, String successUrl, ApplicationInitialize applicationInitialize) {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException {
        ...
        // 生成AccessJwt
//        AccessJwtToken accessJwt = jwtFactory.generalAccessJwt(user.getUsername());
...
//        factory.getCacheClient().putTimeOut(Access_Jwt_Cache, accessJwt.getToken(), (int) jwtFactory.getSettings().getExpiration().getSeconds());

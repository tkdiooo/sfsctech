...
import com.sfsctech.core.auth.sso.common.jwt.extractor.JwtHeaderTokenExtractor;
...
import com.sfsctech.core.auth.sso.common.matcher.SkipPathRequestMatcher;
...
public class SSOConfig extends BaseWebSecurityConfig {
    ...
    protected JwtTokenAuthenticationProcessingFilter buildJwtTokenAuthenticationProcessingFilter() {
        ...
        JwtTokenAuthenticationProcessingFilter filter = new JwtTokenAuthenticationProcessingFilter(new AuthenticationFailureHandler(), tokenExtractor(), jwtTokenFactory(), matcher);

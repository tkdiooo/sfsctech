...
public class JwtTokenAuthenticationProcessingFilter extends AbstractAuthenticationProcessingFilter {
    ...
    @Autowired
    public JwtTokenAuthenticationProcessingFilter(AuthenticationFailureHandler failureHandler, TokenExtractor tokenExtractor, JwtTokenFactory jwtTokenFactory, RequestMatcher matcher) {
        super(matcher);
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        RawAccessJwtToken token = new RawAccessJwtToken(tokenExtractor.extract(tokenPayload), jwtTokenFactory);

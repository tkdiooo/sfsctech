package com.sfsctech.common.data.mybatis.datasource.aspect;

import com.sfsctech.common.data.mybatis.annotation.DataSource;
...
public class DynamicDataSourceAspect {
    ...
    // 有注解DataSource的类或者方法
    @Pointcut("@within(com.sfsctech.common.data.mybatis.annotation.DataSource) || @annotation(com.sfsctech.common.data.mybatis.annotation.DataSource)")
    @AdviceName("")

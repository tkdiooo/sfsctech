package com.sfsctech.common.data.mybatis.dao.monitor;
...
import com.sfsctech.common.core.base.domain.model.PagingInfo;
import com.sfsctech.common.core.cache.factory.CacheProxy;
import com.sfsctech.common.core.cache.factory.CacheProxyFactory;
import com.sfsctech.common.data.mybatis.dao.IBaseDao;
...
public abstract class MyBatisDaoSupportMonitor<T, PK extends Serializable, Example> extends SqlSessionDaoSupport implements IBaseDao<T, PK, Example> {
    ...
    private CacheProxyFactory<CacheProxy<String, Object>> cacheClient;

    protected void setCacheFactory(CacheProxyFactory<CacheProxy<String, Object>> cacheClient) {
        this.cacheClient = cacheClient;
    }

    protected CacheProxy<String, Object> getCacheClient() {

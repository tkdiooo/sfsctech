package com.sfsctech.common.data.mybatis.datasource;

import com.alibaba.fastjson.JSON;
import com.sfsctech.common.data.mybatis.consistenthash.Node;
import com.sfsctech.common.data.mybatis.consistenthash.RoundRobinWeight;
import com.sfsctech.common.data.mybatis.datasource.support.DBType;
import com.sfsctech.common.data.mybatis.datasource.support.DataSourceWrap;
import com.sfsctech.common.data.mybatis.datasource.support.DbTypeHolder;
import com.sfsctech.common.data.mybatis.datasource.support.RecoveryDataSourceThread;
...
public class ReadWriteDataSource extends AbstractDataSource implements InitializingBean {
    ...
    public Connection getReadConnection(String dbName) {
        AssertUtil.notNull(this.resolvedReadDataSources, "Read dataSource router not initialized");
